        ...
        Using conn As New MySqlConnection(sambung)
            ...
            Try
                ...
                Else
                    ...
                    Using comm As New MySqlCommand("UPDATE sadepartment SET " & "ffckode = @kodeBaru, " & "ffcnama = @nama " & "WHERE ffckode = @kodeLama", conn, mTransaksi)

                        comm.Parameters.AddWithValue("@kodeBaru", tkode.Text.Trim())
