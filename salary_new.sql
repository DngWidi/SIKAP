...
-- membuang struktur untuk table salary_new.saprosesseleksi
CREATE TABLE IF NOT EXISTS `saprosesseleksi` (
  `ffcidproses` bigint NOT NULL AUTO_INCREMENT,
  `ffcidrekrutmen` bigint NOT NULL,
  `ffcidkandidat` bigint NOT NULL,
  `ffctahap` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `ffcstatus` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'WAITING',
  `ffdjadwal` datetime DEFAULT NULL,
  `ffdproses` datetime DEFAULT NULL,
  `ffcinterviewer` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ffchasil` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ffcnilai` decimal(5,2) DEFAULT NULL,
  `ffccatatan` text COLLATE utf8mb4_general_ci,
  `ffccreatedby` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ffdcreate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ffcupdatedby` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ffdupdate` datetime DEFAULT NULL,
  PRIMARY KEY (`ffcidproses`),
  KEY `idx_proses_rekrutmen` (`ffcidrekrutmen`),
  KEY `idx_proses_kandidat` (`ffcidkandidat`),
  KEY `idx_proses_tahap` (`ffctahap`),
  KEY `idx_proses_status` (`ffcstatus`)
